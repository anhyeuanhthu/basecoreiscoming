...
namespace BaseCore.Services.Authen
{
    public interface IUserService
    {
        ...
        Task<User> GetByUsername(string username);   // ✅ Thêm phương thức này
    ...
    public class UserService : IUserService
    {
        ...
        {
            // Đảm bảo các trường NOT NULL có giá trị (phòng trường hợp controller bỏ sót)
            if (string.IsNullOrEmpty(user.Contact)) user.Contact = "";
            if (string.IsNullOrEmpty(user.Image)) user.Image = "";
